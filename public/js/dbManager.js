...
function modifySearch() {
    ...
    btn.addEventListener('click', (e) => {
        ...
        fetch(`https://editorialzap.up.railway.app/products/${id}`)
            .then((resp) => resp.json())
            .then(data => {
                const product = data
...
function deleteSend() {
    ...
    btn.addEventListener('click', (e) => {
        ...
        fetch(`https://editorialzap.up.railway.app/products/${id}`, { method: 'DELETE' })
...
function renderSales() {
    ...
    btn.addEventListener('click', () => {
        ...
        fetch(`https://editorialzap.up.railway.app/sales`)
            .then((resp) => resp.json())
            .then(data => {
                const containerCard = document.getElementById('containerCard')
                while (containerCard.firstChild) {
...
const detectBtnDetail = () => {
    ...
    btn.forEach(btn => {
        btn.addEventListener('click', () => {
            let producto = {}
            fetch(`https://editorialzap.up.railway.app/products/${btn.dataset.id}`)
                .then((resp) => resp.json())
                .then(data => {
                    const product = data
